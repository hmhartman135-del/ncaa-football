...
export const getTeams = (params?: Record<string, string | number | undefined>) =>
  api.get("/teams", { params }).then((r) => r.data);

export const getTeam = (school: string, params?: Record<string, string | number | undefined>) =>
...
export const getStandings = (params?: Record<string, string | number | undefined>) =>
  api.get("/standings", { params }).then((r) => r.data);

export const getRankings = (params?: Record<string, string | number | undefined>) =>
...
export const getLeaderboard = (params?: Record<string, string | number | undefined>) =>
...
export const getTeamFullStats = (school: string, params?: Record<string, string | number | undefined>) =>
  api.get(`/analytics/team/${encodeURIComponent(school)}`, { params }).then((r) => r.data);

export const getTeamStatsAnalysis = (school: string, params?: Record<string, string | number | undefined>) =>
  api.get(`/analytics/team/${encodeURIComponent(school)}/discuss`, { params }).then((r) => r.data);

export const getTeamStatRankings = (params?: Record<string, string | number | undefined>) =>
...
export const getRoster = (team: string, params?: Record<string, string | number | undefined>) =>
...
export const analyzeRoster = (team: string, params?: Record<string, string | number | undefined>) =>
  api.get(`/roster/${encodeURIComponent(team)}/analyze`, { params }).then((r) => r.data);

export const getRecruits = (params?: Record<string, string | number | undefined>) =>
  api.get("/recruiting", { params }).then((r) => r.data);

export const getTeamRecruits = (school: string, params?: Record<string, string | number | undefined>) =>
  api.get(`/recruiting/team/${encodeURIComponent(school)}`, { params }).then((r) => r.data);

export const getRecruitingRankings = (params?: Record<string, string | number | undefined>) =>
  api.get("/recruiting/rankings", { params }).then((r) => r.data);

export const get247TeamRankings = (params?: Record<string, string | number | undefined>) =>
  api.get("/recruiting/rankings/247", { params }).then((r) => r.data);

export const getTransferPortal = (params?: Record<string, string | number | boolean | undefined>) =>
...
export const getPortalRankings = (params?: Record<string, string | number | undefined>) =>
...
export const getDraftEligible = (params?: Record<string, string | number | undefined>) =>
  api.get("/draft/eligible", { params }).then((r) => r.data);

export const getDraftBoard = (params?: Record<string, string | number | undefined>) =>
  api.get("/draft/board", { params }).then((r) => r.data);

export const gradeDraftProspect = (playerId: number, params?: Record<string, string | number | undefined>) =>
  api.post(`/draft/grade/${playerId}`, null, { params }).then((r) => r.data);

export const getGameWeeks = (params?: Record<string, string | number | undefined>) =>
  api.get("/games/weeks", { params }).then((r) => r.data);

export const getGamesForWeek = (params?: Record<string, string | number | undefined>) =>
...
export const getRankingWeeks = (params?: Record<string, string | number | undefined>) =>
  api.get("/rankings/weeks", { params }).then((r) => r.data);

export const getApPoll = (params?: Record<string, string | number | undefined>) =>
  api.get("/rankings/poll", { params }).then((r) => r.data);

export const getAiTop25 = (params?: Record<string, string | number | undefined>) =>
  api.get("/rankings/ai-top25", { params }).then((r) => r.data);

export const generateAiTop25 = (params?: Record<string, string | number | undefined>) =>
